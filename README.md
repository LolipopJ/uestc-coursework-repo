...
[Android Lifecircle 测试](./android-LifecircleTest)|**Android**|移动计算及应用开发技术课程作业，基于 [Lifecircle 组件](https://developer.android.com/topic/libraries/architecture/lifecycle.html)实现处理 Android 应用的生命周期行为。
