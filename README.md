...
[大数据计算技术](./pdf-大数据计算技术)|Hadoop 和 Mapreduce 的运用等|实验0-Vmware及Ubuntu安装配置，实验1-Hadoop和Spark安装配置以及实验2-Mapreduce实现Wordcount实例合并为[此实验报告](./pdf-大数据计算技术/实验012实验报告.pdf)；实验3-航空公司延误和取消分析的[操作步骤](./pdf-大数据计算技术/实验3操作步骤.pdf)。
